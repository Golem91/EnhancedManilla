$data merge entity @s {NoGravity:1b,Small:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,Tags:["raycast","uinit"],ArmorItems:[{},{},{},{id:"minecraft:black_dye",Count:1b,tag:{UUID:$(UUID),CustomModelData:1}}]}
